...
internal class LifeInsuranceServiceTest {
    ...
    @Autowired
    private lateinit var lifeRiskScoreService: LifeInsuranceService

    @Test
    fun `should return ineligible life risk score`() {
        val riskScore = lifeRiskScoreService.plan(0, 61, MaritalStatusEnum.MARRIED, 1)
    ...
    fun `should return economic life risk score`() {
        val riskScore = lifeRiskScoreService.plan(-1, 42, MaritalStatusEnum.MARRIED, 0)
    ...
    fun `should return regular life risk score`() {
        val riskScore = lifeRiskScoreService.plan(0, 42, MaritalStatusEnum.MARRIED, 1)
    ...
    fun `should return responsible life risk score`() {
        val riskScore = lifeRiskScoreService.plan(1, 42, MaritalStatusEnum.MARRIED, 1)
